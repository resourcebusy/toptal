...
# We write the key to /var because it's one of the few directories 
# that A) is writeable, and B) persists between reboots. 
# B is important because GCP will automatically reboot the server if it goes down. 
# We don't want to lose the key after a reboot.
